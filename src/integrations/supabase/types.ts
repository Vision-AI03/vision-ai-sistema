  ...
  public: {
    Tables: {
      ...
      analise_lead_ia: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "v_cockpit_leads_parados"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      contratos_preenchidos: {
        ...
        Relationships: [
          {
            foreignKeyName: "contratos_preenchidos_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
      ...
      lista_membros: {
        ...
        Relationships: [
          {
            foreignKeyName: "lista_membros_lead_id_fkey"
            columns: ["lead_id"]
            isOneToOne: false
            referencedRelation: "leads"
            referencedColumns: ["id"]
          ...
          },
          {
            ...
            columns: ["lista_id"]
            isOneToOne: false
            referencedRelation: "listas_email"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      mercado_itens: {
        ...
        Relationships: [
          {
            foreignKeyName: "mercado_itens_fonte_id_fkey"
            columns: ["fonte_id"]
            isOneToOne: false
            referencedRelation: "mercado_fontes"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      radar_chat_mensagens: {
        ...
        Relationships: [
          {
            foreignKeyName: "radar_chat_mensagens_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
            referencedRelation: "radar_chat_threads"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      emails_enviados_hoje: { Args: never; Returns: number }
